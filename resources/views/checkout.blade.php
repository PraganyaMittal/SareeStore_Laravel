                        ...
                        <div class="sticky-content">
                                    ...
                                    <table class="checkout-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">-Rs.{{Session("discounts")["discount"]}}</td>
                                            </tr>
                                            <tr>
                                                <th>Subtotal After Discount</th>
                                                <td class="text-right">Rs.{{Session("discounts")["subtotal"]}}</td>
                                            </tr>
                                            <tr>
                                                <th>SHIPPING</th>
                                            ...
                                            <tr>
                                                <th>VAT</th>
                                                <td class="text-right">Rs.{{Session("discounts")["tax"]}}</td>
                                            </tr>
                                            <tr class="cart-total">
                                                <th>Total</th>
                                                <td class="text-right">Rs.{{Session("discounts")["total"]}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                @else
                            ...
                            <div class="checkout__payment-methods">
                                ...
                                <div class="policy-text">
                                    ...
                                    throughout this
                                    website, and for other purposes described in our <a href="{{ route('privacy') }}"
