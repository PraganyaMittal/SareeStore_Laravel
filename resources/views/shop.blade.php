            ...
            <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
                ...
                <div class="accordion" id="categories-list">
                    <div class="accordion-item mb-4 pb-3">
						...
						<li class="list-item">
							<span class="menu-link py-1"> <input type="checkbox" name="categories" value="{{$category->id}}" class="chk-category" @if(in_array($category->id,explode(',',$f_categories))) checked="checked" @endif /> {{$category->name}}</span> <span class="text-right float-end">{{$category->products()->count()}}</span>                                        
						</li>
					@endforeach  
                ...
                <div class="accordion" id="brand-filters">
					...
					@foreach ($brands as $brand)
						<li class="list-item">
							<span class="menu-link py-1"> <input type="checkbox" name="brands" value="{{$brand->id}}" class="chk-brand" @if(in_array($brand->id,explode(',',$f_brands))) checked="checked" 
                            @endif> {{$brand->name}}</span> <span class="text-right float-end">{{$brand->products()->count()}}</span>
						</li>
					@endforeach                                                                
				</ul>
                            </div>
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                                data-slider-max="10000" data-slider-step="5" data-slider-value="[{{ $min_price }},{{ $max_price }}]"
                                data-currency="Rs." />
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    <span class="text-secondary">Min Price: </span>
                                    <span class="price-range__min">Rs. 1</span>
                                </div>
                                <div>
        ...
        <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #f5e6e0;">
            <div class="slideshow-text container p-3 p-xl-5">
                <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                    Women's <br /><strong>SAREES</strong>
                </h2>
                <p class="mb-0 animate animate_fade animate_btt animate_delay-5">
                    Sarees are the epitome of elegance and tradition. Explore our collection for every occasion, 
                    from timeless classics to modern designs that highlight your beauty.
                </p>
            </div>
        </div>
        <div class="slide-split_media position-relative">
            <div class="slideshow-bg" style="background-color: #f5e6e0;">
                <img loading="lazy" src="{{ asset('1.jpg') }}" width="630" height="450" alt="Women's sarees"
    ...
    <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
        <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #f5e6e0;">
            <div class="slideshow-text container p-3 p-xl-5">
                ...
                <p class="mb-0 animate animate_fade animate_btt animate_delay-5">
                    Discover the grace of sarees. Whether you're looking for a traditional look or a contemporary flair,
                    we offer a variety of sarees to match your style and elegance.
                </p>
            </div>
        </div>
        <div class="slide-split_media position-relative">
            <div class="slideshow-bg" style="background-color: #f5e6e0;">
                <img loading="lazy" src="{{ asset('2.jpg') }}" width="630" height="450" alt="Women's sarees"
                    class="slideshow-bg__img object-fit-cover" />
            </div>
        </div>
    </div>
