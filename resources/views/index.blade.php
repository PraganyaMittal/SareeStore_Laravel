  ...
  <main>
    ...
    <div class="swiper-wrapper">
      ...
      <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
        NEW ARRIVALS</h6>
      <h2 class="h3 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">{{ $slide->title }}</h2>
      <h2 class="h4 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $slide->subtitle }}</h2>
      <a href="{{ $slide->link }}"
    ...
    <section class="category-carousel container">
      ...
      <div class="swiper-slide">
        ...
        src="{{ asset('uploads/categories') }}/{{ $category->image }}" width="124" height="124" alt="" />
    ...
    <section class="hot-deals container">
      ...
      <div class="col-md-6 col-lg-8 col-xl-80per">
        ...
        <a href="{{ route('shop.product.details',['product_slug'=>$sproduct->slug]) }}">
          <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $sproduct->image }}" width="258"
          height="313" alt="{{ $sproduct->name }}" class="pc__img">
    ...
    <section class="products-grid container">
      ...
      <div class="col-6 col-md-4 col-lg-3">
        ...
        <div class="pc__info position-relative">
          ...
          <span class="money price text-secondary">@if($fproduct->sale_price)
