...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $dasboardDatas = DB::select("Select sum(total) as TotalAmount,
    ...
    $TotalCanceledAmount=collect($monthlyDatas)->sum('TotalCanceledAmount');
        ...
        return view("admin.index", compact('orders', 'dasboardDatas','AmountM','OrderedAmountM','DeliveredAmountM','CanceledAmountM','TotalAmount','TotalOrderedAmount','TotalDeliveredAmount','TotalCanceledAmount'));
    }
    ...
    public function GenerateProductThumbnailImage($image, $imageName)
    {
        ...
        $img = Image::read($image->path());
        $img->cover(540, 688, "top");
        $img->resize(540, 688, function ($constraint) {
            $constraint->aspectRatio();
        })->save($destinationPath . '/' . $imageName);
